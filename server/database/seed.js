...
insertTicket.run('TKT-20260310-001', 'PRZA', '201', 'Wasserhahn tropft im Badezimmer', 'normal', 'open', 3, null, '2026-03-10 09:30:00');
insertTicket.run('TKT-20260310-002', 'PRZA', '105', 'Fenster lässt sich nicht schliessen', 'high', 'in_progress', 3, 7, '2026-03-10 14:15:00');
insertTicket.run('TKT-20260311-001', 'MUBRIG', '302', 'Lampe im Flur defekt', 'low', 'open', 4, null, '2026-03-11 08:00:00');
insertTicket.run('TKT-20260311-002', 'HCSI', '12', 'Heizung funktioniert nicht', 'high', 'completed', 6, 7, '2026-03-11 10:45:00');

// Insert sample comments
const insertComment = db.prepare(
  'INSERT INTO ticket_comments (ticket_id, user_id, comment, created_at) VALUES (?, ?, ?, ?)'
);
insertComment.run(2, 7, 'Werde morgen vorbeikommen um das Fenster zu reparieren.', '2026-03-10 16:00:00');

// Insert sample notifications
const insertNotification = db.prepare(
  'INSERT INTO notifications (user_id, ticket_id, message) VALUES (?, ?, ?)'
);
insertNotification.run(7, 1, 'Neues Ticket: Wasserhahn tropft im Badezimmer (Zimmer 201)');
